...
As we can see, inside the red-dotted circle, we have 2 ‘+’ and 1 ‘-’, it is safe for us to assume that the testing point belongs to the ‘+’ class as that is the most common class here
